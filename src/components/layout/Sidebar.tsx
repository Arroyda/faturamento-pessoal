  ...
  return (
    <aside className="hidden w-64 flex-shrink-0 flex-col border-r border-slate-200 bg-white md:flex">
      <div className="flex h-16 items-center gap-2 border-b border-slate-100 px-6">
        ...
        <div>
          <p className="text-sm font-semibold leading-tight text-slate-900">Fat Finance</p>
          <p className="text-[11px] uppercase tracking-wider text-slate-400">Pessoal & Empresa</p>
        </div>
      </div>
